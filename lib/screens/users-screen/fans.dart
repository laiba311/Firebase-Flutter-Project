...
class FanScreen extends StatefulWidget {
  ...
  const FanScreen({Key? key, required this.navigateTo, required this.myIndex}) : super(key: key);
...
class _FanScreenState extends State<FanScreen> {
  ...
  deleteFan(fanId,index){
    setState(() {
      loading3[index] = true;
    });
    https.delete(
      Uri.parse("$serverUrl/fansfans/$fanId/"),
      headers: {
        "Content-Type": "application/json",
        "Authorization": "Bearer $token"
      },
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                if(friends[index].isPrivate == true) ((friends[index].fanList ?? []).contains(int.parse(id)) == false)
                                    ? Container(
                                  width: 90,
                                  child: ElevatedButton(
                                    style: ElevatedButton.styleFrom(
                                ...
                                SizedBox(width: 12,),
                                IconButton(onPressed: loading3[index] == true ? (){} : (){
                                  showDialog(
                                    context: context,
                                    builder: (BuildContext context) {
                                      return AlertDialog(
                                        backgroundColor: primary,
                                        title: Text("Remove fan",style: TextStyle(fontFamily: Poppins,color: ascent,fontSize: 18,fontWeight: FontWeight.bold),),
                                        content: Text("Are you sure you want to delete ${friends[index].username} from your fanlist?",style: TextStyle(fontFamily: Poppins,color: ascent),),
                                        actions: [
                                          TextButton(
                                            onPressed: () {
                                          ...
                                          TextButton(
                                            onPressed: () {
                                              Navigator.pop(context);
                                              deleteFan(friends[index].fanID,index);
                                            },
                                ...
                                }, icon: loading3[index] == true ? SpinKitCircle(color: primary,size: 20,) :  Icon(Icons.close,color: Colors.red,)),
                                //SizedBox(width: 9,),
                              ],
                            ),
                          ],
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                if(filteredFriends[index].isPrivate == true) ((filteredFriends[index].fanList ?? []).contains(int.parse(id)) == false)
                                    ? Container(
                                  width: 90,
                                  child: ElevatedButton(
                                    style: ElevatedButton.styleFrom(
                                    ...
                                    onPressed: () {
                                      if(requestList.any((element) => element["from_user"]["id"].toString() == id && element["to_user"]["id"].toString() == filteredFriends[index].id) == false){
                                        ...
                                        //     content: Text("Are you sure you want to send a fan request to ${filteredFriends[index].username}?",style: TextStyle(color: ascent,fontFamily: Poppins),),
                                        //     actions: [
                                        //       TextButton(
                                        //         child: Text("Cancel",style: TextStyle(color: ascent,fontFamily: Poppins)),
                                        //         onPressed:  () {
                                ...
                                IconButton(onPressed: loading3[index] == true ? (){} : (){
                                  showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return AlertDialog(
                                        title: Text("Fan ${filteredFriends[index].username}",style: TextStyle(fontFamily: Poppins),),
                                        content: Text("Are you sure you want to delete ${filteredFriends[index].username} from your fan list?",style: TextStyle(fontFamily: Poppins),),
                                        actions: [
                                          TextButton(
                                            onPressed: () {
                                              Navigator.of(context).pop();
                                            },
                                            child: Text("Cancel",style: TextStyle(fontFamily: Poppins,color: primary),),
                                          ),
                                          TextButton(
                                            onPressed: () {
                                              Navigator.pop(context);
                                              deleteFan(filteredFriends[index].fanID,index);
                                            },
                                            child: Text("Confirm",style: TextStyle(fontFamily: Poppins,color: primary),),
                                          ),
                                        ],
                                      );
                                    },
