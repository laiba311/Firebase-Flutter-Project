...
class _FriendsIdolsState extends State<FriendsIdols> {
        ...
        jsonDecode(value.body).forEach((data){
          setState(() {
            friends.add(ChatModel(
                ...
                followList: data["idols"]["followList"]
            ));
          });
        });
      });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:loading == true ? SpinKitCircle(size: 50,color: primary,) : (friends.isEmpty ? const Center(child: Text("No Idols",style: TextStyle(fontFamily: Poppins,),)) :
                        ...
                        children: [
                          ...
                          if(friends[index].id != id) Row(
                            ...
                            children: [
                              ...
                              // if(friends[index].isPrivate == true) if((friends[index].fanList ?? []).contains(int.parse(id)) == false && (friends[index].followList ?? []).contains(int.parse(id)) == false)
                              //   Container(
                              //   width: 90,
                              //   child: ElevatedButton(
                              //     style: ElevatedButton.styleFrom(
                      ...
                      child: Row(
                        ...
                        children: [
                                      ...
                                      errorWidget: (context, url,
                                          ...
                                          ClipRRect(
                                              ...
                                              const BorderRadius.all(
                                                  Radius.circular(50)),
                                              child: Image.network(
                                                filteredFriends[index].badge!["document"].toString().replaceAll("https://fashion-time-backend-e7faf6462502.herokuapp.com/", "").replaceAll("https%3A/","https://"),
                                                width: 30,
                                                height: 30,
                                                fit: BoxFit.contain,
                                              )),
                          ...
                          if(filteredFriends[index].id != id) Row(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.end,
                            children: [
                              if(filteredFriends[index].isPrivate == false || (filteredFriends[index].fanList ?? []).contains(int.parse(id)) == true || (filteredFriends[index].followList ?? []).contains(int.parse(id)) == true) idolIdList.contains(int.parse(filteredFriends[index].id)) == true
                                  ? Container(
                                width: 90,
                                    child: ElevatedButton(
                                style: ElevatedButton.styleFrom(
                              ...
                              // if(filteredFriends[index].isPrivate == true && (filteredFriends[index].fanList ?? []).contains(int.parse(id)) == false && (filteredFriends[index].followList ?? []).contains(int.parse(id)) == false) Container(
                              //   width: 90,
                              //   child: ElevatedButton(
                              //     style: ElevatedButton.styleFrom(
                              //       backgroundColor: requestList.any((element) => element["from_user"]["id"].toString() == id && element["to_user"]["id"].toString() == filteredFriends[index].id) == true ? Colors.grey : primary,
