...
class _ReelCommentScreenState extends State<ReelCommentScreen> {
  ...
  void initState() {
    ...
    // Original ReelCommentReplyScreen initialization
  ...
  getCashedData() async {
    ...
    // Add the ReelCommentReplyScreen method call
    getCommentsReply();
  }
    ...
    try {
      https.get(Uri.parse(url), headers: {
        ...
        if (value.statusCode == 200) {
          ...
          debugPrint(
              "error received while getting reel comment=====> ${value.body}");
        }
      });
    } catch (e) {
    ...
    try {
      https.get(Uri.parse(url), headers: {
        ...
        if (value.statusCode == 200) {
          ...
          results = json.decode(value.body)["results"];
          myComments = results
              .where((element) => element['user']['username'] == username)
              .toList();
          results.clear();
                ...
                if (value.statusCode == 201)
                  {
                    Fluttertoast.showToast(
                        msg: "Comment liked", backgroundColor: primary)
                  }
                else
                  {
                    debugPrint(
                        "error received when posting like in comments ${value.body}${value.statusCode}")
                  }
              });
    } catch (e) {
                                                                      ...
                                                                      Flexible(
                                                                        child: CircleAvatar(
                                                                            ...
                                                                            child: ClipRRect(
                                                                              ...
                                                                              child: myComments[index]["user"]["pic"] == null
                                                                                  ? Image.network(
                                                                                      "https://firebasestorage.googleapis.com/v0/b/fashiontime-28e3a.appspot.com/o/WhatsApp_Image_2023-11-08_at_4.48.19_PM-removebg-preview.png?alt=media&token=215bdc12-d53a-4772-bca1-efbbdf6ee955&_gl=1*nea8nk*_ga*NDIyMTUzOTQ2LjE2OTkyODU3MDg.*_ga_CW55HF8NVT*MTY5OTQ0NDE2NS4zMy4xLjE2OTk0NDUxNzcuNTYuMC4w",
                                                                                      width: 40,
                                                                                      height: 40,
                                                                                  ...
                                                                                  : CachedNetworkImage(
                                                                                      imageUrl: myComments[index]["user"]["pic"],
                                              ...
                                              GestureDetector(
                                                onLongPress: () {
                                                  Navigator.push(
                                                      ...
                                                      MaterialPageRoute(
                                                        builder: (context) =>
                                                            ReportReelCommentScreen(
                                                                commentId:
                                                                    results[index]
                                                                        ['id']),
                                                      ));
                                                },
                                                child: results[index]['comment']
                                                        .toString()
                                                        .startsWith(
                                                            "https://media")
                                                    ? buildGifWidget(
                                                                    ...
                                                                    Flexible(
                                                                      child: CircleAvatar(
                                                                          ...
                                                                          child: ClipRRect(
                                                                            ...
                                                                            child: results[index]["user"]["pic"] == null
                                                                                ? Image.network(
                                                                                    "https://firebasestorage.googleapis.com/v0/b/fashiontime-28e3a.appspot.com/o/WhatsApp_Image_2023-11-08_at_4.48.19_PM-removebg-preview.png?alt=media&token=215bdc12-d53a-4772-bca1-efbbdf6ee955&_gl=1*nea8nk*_ga*NDIyMTUzOTQ2LjE2OTkyODU3MDg.*_ga_CW55HF8NVT*MTY5OTQ0NDE2NS4zMy4xLjE2OTk0NDUxNzcuNTYuMC4w",
                                                                                    width: 40,
                                                                                    height: 40,
                                                                                ...
                                                                                : CachedNetworkImage(
                                                                                    imageUrl: results[index]["user"]["pic"],
                                                                                    imageBuilder: (context, imageProvider) => Container(
                                                                                      height: 100,
                                                                                      width: 100,
                                                                                      decoration: BoxDecoration(
                                                      ...
                                                      : InkWell(
                                                          ...
                                                          child: Align(
                                                              alignment: Alignment
                                                                  .centerRight,
                                                              child: Text(
                                                                "View ${results[index]["replyReelCommentsCount"]} more replies",
                                                                style:
                                                                    TextStyle(
                                                                  fontFamily:
                                                                      Poppins,
