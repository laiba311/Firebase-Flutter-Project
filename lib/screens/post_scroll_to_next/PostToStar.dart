...
class PostScrollToStar extends StatefulWidget {
  ...
  final int index;
  final Function navigateToReportScreen;
  final Function navigateToPageWithPostArguments;
  final int myIndex;
  final Function navigateTo;
  PostScrollToStar({super.key, required this.title,this.posts, required this.index, required this.navigateToReportScreen, required this.navigateToPageWithPostArguments, required this.myIndex, required this.navigateTo});
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  PopupMenuButton(
                                      ...
                                      onSelected: (value) {
                                        if (value == 0) {
                                          widget.navigateToReportScreen(28,widget.posts![index].userid);
                                          // Navigator.push(
                                          //     context,
                                          //     MaterialPageRoute(
                                          //         builder: (context) =>
                              ...
                              child: widget.posts![index].userid == id
                                ...
                                children: [
                                  widget.posts![index].addMeInFashionWeek ==
                                      ...
                                      : IconButton(
                                      onPressed: () {
                                        widget.navigateToPageWithPostArguments(29,widget.posts![index].id);
                                        // Navigator.push(
                                        //     context,
                                        //     MaterialPageRoute(
                                        //       builder:
                                      ...
                                      children: [
                                        isExpanded
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              "${handleEmojis(widget.posts![index].description.length > 10 ? widget.posts![index].description.substring(0,10): widget.posts![index].description)}...",
                                              style:
                                              const TextStyle(
                                                fontFamily:
                                                Poppins,
