...
class AllFashionWeeks1 extends StatefulWidget {
  final int myIndex;
  final Function navigateTo;
  const AllFashionWeeks1({super.key, required this.myIndex, required this.navigateTo});

  @override
  State<AllFashionWeeks1> createState() => _AllFashionWeeks1State();
}
List<FashionEvent> events = [];
bool loading =false;

class _AllFashionWeeks1State extends State<AllFashionWeeks1> {
  getAllEvents(){
