...
import 'package:finalfashiontimefrontend/customize_pacages/mentions/src/mention_text_field_controller.dart';
...
class MentionTextField extends StatefulWidget {
  ...
  final bool expands;
  final bool readOnly;
  final VoidCallback? onSuggestionListToggle; // Add this callback
  final bool? forceCloseSuggestions;
  ...
  const MentionTextField({
    ...
    this.onSuggestionListToggle,
    this.forceCloseSuggestions,
...
class _MentionTextFieldState extends State<MentionTextField> {
  ...
  void didUpdateWidget(covariant MentionTextField oldWidget) {
    ...
    if (oldWidget.forceCloseSuggestions != widget.forceCloseSuggestions &&
        widget.forceCloseSuggestions == true) {
      closeSuggestions();
    }
  ...
  void closeSuggestions() {
    ...
    removeMentionList();
    widget.onSuggestionListToggle?.call();
  }
        ...
        children: [
          ...
          ValueListenableBuilder(
            ...
            builder: (context, show, child) {
              return Positioned(
                height: MediaQuery.of(context).viewInsets.bottom > 0 ? MediaQuery.of(context).size.height * 0.55 : MediaQuery.of(context).size.height * 0.87,
