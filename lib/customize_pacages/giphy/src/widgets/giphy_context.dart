...
import 'package:finalfashiontimefrontend/customize_pacages/giphy/src/widgets/giphy_error_view.dart';
import 'package:finalfashiontimefrontend/customize_pacages/giphy/src/widgets/giphy_search_text.dart';
import 'package:finalfashiontimefrontend/customize_pacages/giphy/src/widgets/giphy_thumbnail_grid.dart';
...
typedef SearchTextBuilder = Widget Function(BuildContext context,
    TextEditingController controller, ValueChanged<String> onChanged, ScrollController scrollController);
...
class GiphyContext extends InheritedWidget {
  ...
  static Widget _buildDefaultSearchText(
    ...
    ValueChanged<String> onChanged,
      ...
      GiphySearchText(controller: controller, onChanged: onChanged, scrollController: scrollController,);
