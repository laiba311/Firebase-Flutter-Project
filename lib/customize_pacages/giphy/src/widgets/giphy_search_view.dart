...
import 'package:finalfashiontimefrontend/customize_pacages/giphy/src/utils/debouncer.dart';
import 'package:finalfashiontimefrontend/customize_pacages/giphy/src/widgets/giphy_attribution_mark.dart';
...
class GiphySearchView extends StatefulWidget {
  ...
  const GiphySearchView({super.key, required this.myScrollController});
                ...
                if (snapshot.hasData) {
                  if (snapshot.data!.totalCount > 0) {
                    final child = giphy.resultsBuilder(
                        context, snapshot.data!, widget.myScrollController);
